...
Launch Application
    ...
    ${options}=    Set Variable    add_argument("--log-level=3"); add_argument("--disable-logging"); add_argument("--silent")
...
Enter User Credentials
    ...
    # Fluent Wait removed (Launch Application already confirms page load)
...
Capture Screenshot Evidence
    [Documentation]    Captures screenshot as test evidence with provided name.
    [Arguments]    ${name}
